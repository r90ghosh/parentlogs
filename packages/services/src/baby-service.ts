import type { Baby, FamilyStage } from '@tdc/shared/types'
import type { AppSupabaseClient, ServiceContext } from './types'

export function createBabyService(supabase: AppSupabaseClient) {
...
export type BabyService = ReturnType<typeof createBabyService>
