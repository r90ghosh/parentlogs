...
title: "What Our Baby Actually Cost in Year One (Real Numbers)"
excerpt: "$23,847. I tracked every diaper subscription, every late-night Target run, every lactation consultant our insurance didn't cover. Here's the full breakdown."
category: budget
tags: ["third-trimester", "fourth-trimester", "3-6-months", "6-12-months"]
meta_title: "Baby Cost First Year: Real Numbers Breakdown"
meta_description: "What a baby actually costs in year one. Real tracked expenses from a real family, broken down by category with specific dollar amounts."
...
| Item | Cost | Notes |
|------|------|-------|
| Prenatal care (copays, 12 visits) | $480 | $40 per visit after insurance |
| Hospital delivery | $3,200 | Hit our out-of-pocket max. C-section would've been the same thanks to that cap. |
| Lactation consultant (3 visits) | $450 | Insurance covered 1. We paid for 2 more out of pocket. Worth every dollar. |
| Pediatrician visits (year 1) | $560 | Well-baby visits + 2 sick visits + an ear infection scare |
| Prescriptions (baby + mom postpartum) | $185 | Vitamin D drops, gas drops, mom's postpartum meds |
| Breast pump | $0 | Insurance covered it, but only one specific model. Check your plan early. |
| **Subtotal** | **$4,875** | |
...
| Category | Amount |
|----------|--------|
| Medical/Insurance | $4,875 |
| Gear & Equipment | $2,340 |
| Diapers & Supplies | $1,028 |
| Formula & Food | $1,050 |
| Childcare (part-time) | $9,600 |
| Clothing | $390 |
| Meal delivery/DoorDash premium | $480 |
| Grocery inflation | $1,800 |
| Misc. Target/Amazon runs | $600 |
| **Total** | **$22,163** |
