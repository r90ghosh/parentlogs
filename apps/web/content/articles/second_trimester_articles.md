...
| Category | Details |
|----------|---------|
| **Baby size** | Banana (6.5 inches, 10 oz) |
| **Key milestone** | Anatomy scan checks all major organ systems |
| **Dad priority** | Be at this appointment—this one is non-negotiable |
| **Source** | Cleveland Clinic, March of Dimes |
...
| Category | Details |
|----------|---------|
| **Baby size** | Papaya (11 inches, 1 pound) |
| **Key milestone** | Sleep-wake cycles developing; balance system coming online |
| **Dad priority** | Paint and assemble now—this window won't last |
| **Source** | March of Dimes, American SPCC |
...
| Category | Details |
|----------|---------|
| **Baby size** | Ear of corn (12 inches, 1.3 pounds) |
| **Key milestone** | Lungs producing surfactant; viability threshold reached |
| **Dad priority** | Schedule hospital tour and childbirth classes |
| **Source** | Cleveland Clinic, NIH |

**Sources:** Cleveland Clinic Fetal Development, NIH Pregnancy Facts, March of Dimes Week by Week
...
| Category | Details |
|----------|---------|
| **Baby size** | Head of lettuce (14.5 inches, 2 pounds) |
| **Key milestone** | Eyes opening; REM sleep patterns present |
| **Dad priority** | Finalize nursery, complete registry, start hospital bag list |
| **Source** | March of Dimes, Cleveland Clinic |
...
- **NIH Pregnancy Facts:** https://www.nichd.nih.gov/health/topics/factsheets/pregnancy
- **March of Dimes Week by Week:** https://www.marchofdimes.org/pregnancy-week-week
- **Cleveland Clinic Fetal Development:** https://my.clevelandclinic.org/health/articles/7247-fetal-development-stages-of-growth
- **American SPCC Fetal Stages:** https://americanspcc.org/pregnancy-stages-of-fetal-development/
