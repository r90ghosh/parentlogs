...
| | |
|---|---|
| **Baby size** | Cabbage (~3 lbs, 15.7 inches) |
| **Key milestone** | Brain developing rapidly, controlling body temperature |
| **Dad priority** | Install car seat and get it inspected by CPST |
| **Sources** | March of Dimes, Safe Kids Worldwide, Cleveland Clinic |
...
| | |
|---|---|
| **Baby size** | Cantaloupe (~4.7 lbs, 17.7 inches) |
| **Key milestone** | Lungs nearly mature, producing surfactant |
| **Dad priority** | Finalize pediatrician selection—deadline this week |
| **Sources** | March of Dimes, NIH/PMC, ACOG |
...
| | |
|---|---|
| **Baby size** | Honeydew melon (~6 lbs, 18.7 inches) |
| **Key milestone** | Lungs completely formed, entering "early term" |
| **Dad priority** | Know hospital route(s), final bag check, work handoff complete |
| **Sources** | March of Dimes, Cleveland Clinic, American Pregnancy Association |
...
| | |
|---|---|
| **Baby size** | Small pumpkin (~6.8 lbs, 19.6 inches) |
| **Key milestone** | Baby dropping into position, fully developed |
| **Dad priority** | Stay charged, know labor signs, be ready 24/7 |
| **Sources** | March of Dimes, Kaiser Permanente, NHS, WebMD |
...
| | |
|---|---|
| **Baby size** | Watermelon (~6-9 lbs, 18-20 inches) |
| **Key milestone** | Due date—baby fully developed and ready |
| **Dad priority** | Stay calm, know when to go, support her through the wait |
| **Sources** | March of Dimes, Cleveland Clinic, HealthPartners, WebMD |
...
- CDC Pregnancy: https://www.cdc.gov/pregnancy/during/index.html
- March of Dimes Week by Week: https://www.marchofdimes.org/pregnancy-week-week
- NIH/PMC Research on Fetal Lung Development

**Labor & Delivery:**
- Cleveland Clinic: Labor Signs, Lightning Crotch, Prodromal Labor
- Kaiser Permanente: When to Go to the Hospital
- NHS: Signs that Labour Has Begun
- WebMD: Signs of Labor

**Safety & Preparation:**
- Safe Kids Worldwide / National CPS Certification
